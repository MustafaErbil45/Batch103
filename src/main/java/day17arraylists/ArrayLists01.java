...
public class ArrayLists01 {
    ...
    public static void main(String[] args) {
       ...
       boolean sonuc1 = names.containsAll(myNames);//Bir listin içinde coklu elemanların olup olmadığını kontrol eder.
        ...
        //Example 2:"a" listinde "shoes" elemanın tüm görünümlerini siliniz.
       ...
       a.removeAll(silinecekler);
        ...
        //Example 3: bir tane salary(maaş) listi oluşturun, eger salary 10000 den az ise %20 10000 ve 10000den cok ise %10 zam yapınız.
    ...
    System.out.println(salary);
        ...
        //Example 4:İki Array'in eşit olup olmadığını kontrol ediniz
